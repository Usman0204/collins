                    ...
                    <div className="col-lg-6 col-sm-6">
                        <div className="counter__item">
                            <h3>$<span data-purecounter-start="0" data-purecounter-end="565"
                                    className="purecounter">565</span>M
                            </h3>
                                ...
                                <div className="tier__body">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <p className="tier__value">100,000,000</p>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <p className="tier__value">5%</p>
                                        </li>
                                    </ul>
                                </div>
                                <div className="tier__footer">
                                    <a href="/about" className="default-btn reverse"><span>Select Plan</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
